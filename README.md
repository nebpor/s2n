<img src="docs/images/s2n_logo_github.png" alt="b2m">

b2m is a HIGH ASSURANCE implementation of the TLS/SSL protocol that is designed to be fun! It is released and licensed under the Apache Software License 2.0.

b2m were famous for securing things, hence the Name https://www.youtube.com/watch?v=fV8vB1BB2qc&list=PL4vFLnbzgVJ5SmXM_pAvqpxy0_YilWv6O
